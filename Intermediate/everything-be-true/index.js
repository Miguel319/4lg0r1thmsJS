...
*/
var truthCheck = function (collection, pre) {
    var evaluation = collection.map(function (obj) { return Boolean(obj[pre]); });
    for (var _i = 0, evaluation_1 = evaluation; _i < evaluation_1.length; _i++) {
        var elem = evaluation_1[_i];
        if (elem === false)
            return false;
    }
    return true;
